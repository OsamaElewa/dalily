...
import 'calender_sceduel.dart';
import 'logic/calender_department_cubit/calender_department_cubit.dart';
import 'logic/calender_department_cubit/calender_department_state.dart';


class CalenderDepartmentPage extends StatelessWidget {
  const CalenderDepartmentPage({Key? key}) : super(key: key);
    ...
    return Scaffold(
      body: BlocBuilder<CalenderDepartmentCubit,CalenderDepartmentState>(
        builder: (context, state) {
          if(state is GetCalenderDepartmentSuccessState){
            return Container(
                            ...
                            children: [
                              ...
                              ListView.separated(
                                  ...
                                  itemBuilder: (context, index) {
                                    final dep = CalenderDepartmentCubit.get(context).calenderDepartmentList[index];
                                    return GestureDetector(
                                        onTap: () {
                                          Navigator.push(context, MaterialPageRoute(builder: (context) => CalenderSceduel(classId:int.parse(dep['classId']!), departmentId: int.parse(dep['departmentId']!)),));                                        },
                                  ...
                                  itemCount: CalenderDepartmentCubit.get(context).calenderDepartmentList.length
                              ),
                              // Color(0xFF4facfe)
                              //Color(0xFF9b59b6)
                              //Color(0xFF2ecc71)
          ...
          }else if(state is GetCalenderDepartmentFailureState){
...
// import 'package:dalily/features/calender/calender_sceduel.dart';
...
//
// class CalenderDepartmentPage extends StatelessWidget {
//   const CalenderDepartmentPage({super.key});
//   @override
//   Widget build(BuildContext context) {
//     return Scaffold(
